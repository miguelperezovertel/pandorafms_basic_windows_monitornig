...
For Each objItem in colItems
	...
	call outputModuleGenericData("Logical Disk - " & objItem.Name & " - Avg Disk Queue Length", "", objItem.AvgDiskQueueLength)
	
	'Wscript.Echo "Average Disk Read Queue Length: "    & objItem.AvgDiskReadQueueLength
	call outputModuleGenericData("Logical Disk - " & objItem.Name & " - Avg Disk Read Queue Length", "", objItem.AvgDiskReadQueueLength)
	...
	call outputModuleGenericData("Logical Disk - " & objItem.Name & " - Avg Disk Write Queue Length", "", objItem.AvgDiskWriteQueueLength)
	...
	call outputModuleGenericData("Logical Disk - " & objItem.Name & " - Disk Read Bytes Per sec", "", objItem.DiskReadBytesPersec)
	...
	call outputModuleGenericData("Logical Disk - " & objItem.Name & " - Disk Write Bytes Per sec", "", objItem.DiskWriteBytesPersec)
	...
	call outputModuleGenericData("Logical Disk - " & objItem.Name & " - Split I/O Per Second", "", objItem.SplitIOPerSec)
	'Wscript.Sleep 2000
	'objRefresher.Refresh
Next
